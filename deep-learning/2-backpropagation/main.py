...
#%% 
# Test
test_x, test_t = generate_data(11506)
train_acc = model.mean_accuracy(x, t)
test_acc = model.mean_accuracy(test_x, test_t)
print(f'Test acc {test_acc}')
print(f'Generalization gap: {abs(test_acc - train_acc)}')
